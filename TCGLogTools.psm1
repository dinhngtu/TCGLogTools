...
$Script:SIPAEventMapping = @{
    ...
    0x00050029 = 'SBCPInfo'                     # SIPAEVENT_SBCP_INFO
    0x00050030 = 'HypervisorBootDMAProtection'  # SIPAEVENT_HYPERVISOR_BOOT_DMA_PROTECTION
    0x00050031 = 'SIPolicySigner'               # SIPAEVENT_SI_POLICY_SIGNER, SIPAEVENT_SI_POLICY_SIGNER_PAYLOAD
    0x00050032 = 'SIPolicyUpdateSigner'         # idem.
    0x00050033 = 'ReFSVolumeCheckpointRecordChecksum'           # SIPAEVENT_REFS_VOLUME_CHECKPOINT_RECORD_CHECKSUM
    0x00050034 = 'ReFSRollbackProtectionFrozenVolumeChecksum'   # SIPAEVENT_REFS_ROLLBACK_PROTECTION_FROZEN_VOLUME_CHECKSUM
    0x00050035 = 'ReFSRollbackProtectionUserPayloadHash'        # SIPAEVENT_REFS_ROLLBACK_PROTECTION_USER_PAYLOAD_HASH
    0x00050036 = 'ReFSRollbackProtectionVerificationSucceeded'  # SIPAEVENT_REFS_ROLLBACK_PROTECTION_VERIFICATION_SUCCEEDED
    0x00050037 = 'ReFSRollbackProtectionVolumeFirstEverMount'   # SIPAEVENT_REFS_ROLLBACK_PROTECTION_VOLUME_FIRST_EVER_MOUNT
    ...
    0x000A0009 = 'VBSDumpUsesAMERoot'            # SIPAEVENT_VBS_DUMP_USES_AMEROOT
    0x000A000A = 'VBSVSMNosecretsEnforced'       # SIPAEVENT_VBS_VSM_NOSECRETS_ENFORCED
